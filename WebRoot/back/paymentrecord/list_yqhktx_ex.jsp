		...
		<tbody class="table_solid">
			...
			<c:forEach items="${dataList}" var="data">
				<tr> 
					...
					<td class='xlsMoney'><fmt:formatNumber value="${data.currenyamount}" pattern="#0.00"/><c:set value="${data.currenyamount+total_obj}" var="total_obj"/>
					</td> 
			 ...
			 <tr> 
				...
				<td></td>
				<td></td> 
				<td class='xlsMoney'><fmt:formatNumber  value="${total_obj}" pattern="#0.00"/></td> 
				<td></td> 
				<td></td>  
				<td></td>   
				<td></td>    
