...
<body>
<form action="paymentRecord/paymentRecordAction!list_qianyue_sell">
...
<div class="dataList ui-widget">
	<table>
		<thead>
			<tr>
				<th style="text-align: center;font-size:22px;">昆投互联网金融交易-${bank}签约用户债权卖出</th>
			</tr>
		</thead>
		<tbody>
			<table class="ui-widget ui-widget-content" id="mytable" style="font-size:12px;">
				...
				<c:forEach items="${pageView.records}" var="iter">
					<tr>
						...
						<td><fmt:formatNumber value="${iter.sellingPrice}" pattern="0.00"/>元</td>
						...
						<td>
							${iter.seller.username}/${iter.seller.realname}/${iter.id}/${iter.seller.accountNo}
						</td>
						<td>
							<fmt:formatDate value="${iter.seller.signDate}" type="both"/>
						</td>
