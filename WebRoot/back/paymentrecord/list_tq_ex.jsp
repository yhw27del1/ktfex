	...
	<body style="text-align: center;"> 
		<table align="center" border="1" style="width:600px;">
			 <tr style="width: 100%;">
				<td align="center" colspan="10">
					<div>
					      (<fmt:formatDate value="${startDate}" pattern="yyyy-MM-dd"  />:<fmt:formatDate value="${endDate}" pattern="yyyy-MM-dd"  />)提前还款记录查询(单位:元)  
					</div>
				</td>
				</tr> 
			<thead>
		...
		<c:forEach items="${pageView.records}" var="iter">
			<tr> 
				...
				</c:if>/${iter.investRecord.investor.user.username}
				</td>
