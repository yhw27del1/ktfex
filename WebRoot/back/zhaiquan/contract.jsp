...
<html>
  ...
  <div style="width:800px; overflow:hidden;margin: 0 auto;">
  	...
  	<div class="bold">签署时间：<FONT color="red"><fmt:formatDate value="${this_.sellerDate}" pattern="yyyy-MM-dd"/></FONT></div>
  	<div class="bold">乙方会员编号：${this_.buyer.username }</div>
  	<div class="bold">签署时间：<FONT color="red"><fmt:formatDate value="${this_.buyerDate}" pattern="yyyy-MM-dd"/></FONT></div>
  	<div class="bold">丙方：昆投互联网金融交易</div>
  	<div class="bold">法定代表人：XXX</div>
  	<div class="bold">电子协议发布时间：<FONT color="red"><fmt:formatDate value="${this_.fbrq}" pattern="yyyy-MM-dd"/></FONT></div>
  </div>
