		...
		<div style="width:900px;overflow-x:hidden;margin-left:auto;margin-right:auto;margin-top:30xp;">
			<div>
				<h1 class="bold center">
					借款合同<input id="financingBaseId" type="hidden" value="${financingBaseId}" />
				</h1>
			</div>
			...
			<div class="l4">
				...
				<span class="key"><fmt:formatDate value="${contract.end_date}" pattern="yyyy年MM月dd日" />止
				</span>。
			</div>
			<div class="l2">
			...
			<div class="l2">
				<span class="bold">第七条</span> 甲方授权丙方向乙方收取其归还的本金及利息以及约定的其他罚息、违约金等。丙方收到乙方归还的上述款项后，应于三个交易日内，按照相关交易规则，将相应款项经结算后清算至甲方对应的交易账户。
			</div>
			...
			<div class="l4">
				七、针对本合同约定借款，乙方累计出现需要保证机构代偿款项的逾期还款违约行为的；前述逾期还款不应当包括乙方在保证人代偿期间，清偿当期应还款额的情况。保证人代偿期间，是指保证人签订的《保证合同》中约定的，保证人应当代为清偿被担保债务的期间，分为3日、7日、15日不等，具体以《保证合同》约定为准。
			</div>
			<div class="l4">
			...
			<div class="l4">
				二、乙方未按本合同约定按时、足额偿还借款本息的，自逾期之日起应向甲方每日按应还款金额的 <span class="key">0.01%</span> 支付滞纳金。
			</div>
			<div class="l4">
				三、在本合同项下的借款本息全部清偿前，乙方的联系方式、实际居住地、工作单位、资产、负债等情况发生变化，未在变更后三日内书面通知丙方的，上述行为每发生一次，乙方应向甲方支付<span class="key">500</span>元/项（次）的违约金，可由丙方代收。
			</div>
			<div class="l4">
				四、在本合同履行期间，乙方拒不履行还款义务或无力清偿欠款，而最终导致甲方付诸法律的，乙方应承担由此所产生的全部费用，包括但不限于律师代理费、评估费、鉴定费、差旅费等，同时有权按照本条第二款之约定主张违约金。
			</div>
			<div class="l4">尽管甲乙双方在第十八条授权丙方，以及丙方根据该授权行使权利，但是，丙方没有向甲方支付、赔付、垫付任何款项的经济责任，丙方只有代收、代转已经从乙方收到的债款的义务和经济责任。甲方要求丙方向债务人追收欠款的，甲方需预付追债费用。</div>
			<div class="l2">
