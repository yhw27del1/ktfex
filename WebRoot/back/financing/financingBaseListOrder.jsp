...
<body>
<form id="form1" action="/back/financingBaseAction!for_order" method="post"> 
	...
	<table class="ui-widget ui-widget-content">
		...
		<c:forEach items="${pageView.records}" var="entry">
			<tr> 
				...
				<td> 
					<c:if test="${entry.state=='1.5'}">
					      <button onclick="toURL('/back/financingBaseAction!guadanUI?id=${entry.id}');return false;" class="ui-state-default"  style="display:<c:out value="${menuMap['financingBase_guadan']}"/>" >挂单</button>
	 				</c:if>  
