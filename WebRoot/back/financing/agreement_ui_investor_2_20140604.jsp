...
<html>
	...
	<body>
		...
		<table width="100%" id="main_table">
			...
			<tr>
				<td class="l2"><span class="bold">第八条</span>
				　　第八条 甲方授权丙方向乙方收取其归还的本金及利息以及约定的其他罚息、违约金等。丙方收到乙方归还的上述款项后，应于三个交易日内，按照相关交易规则，将相应款项经结算后清算至甲方对应的交易账户。</td>
			</tr>
			<tr>
...
前述累计三期或三期以上逾期还款不应当包括乙方在保证人代偿期间，清偿当期应还款额的情况　　保证人代偿期间，是指保证人签订的《保证合同》中约定的，保证人应当代为清偿被担保债务的期间，分为3日、7日、15日不等，具体以《保证合同》约定为准。</td></tr>
