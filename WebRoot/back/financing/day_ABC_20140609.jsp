...
<html>
	...
	<body>
		...
		<table width="100%" id="main_table">
			<tr><td class="bold center">
				<h2>
					借款合同
				</h2>
			</td></tr>
			<tr><td class="bold right">
			...
			<tr><td class="bold">丙方（投融资服务人）：昆投互联网金融交易</td></tr>
			<tr><td class="l2">鉴于，</td></tr>
			<tr>
			<td class="l2">
				甲乙双方是丙方的注册会员，甲方持有合法资金并自愿寻求投资对象，获取投资收益，乙方需要资金维持经营/创业/发展事业/或者个人事务，丙方是依法注册成立的投资咨询中介服务机构，具有规范、安全交易服务的完善机制，帮助交易双方实现投融资。为此，本合同三方根据我国《民法通则》、《合同法》、民间借贷政策法规、金融管理法规等相关法律法规，在自愿、平等、协商一致的基础上，签订本合同，各方信守。
			</td>
			</tr>
			
			<tr>
			<td class="l2">
				<span class="bold">第一条</span> 甲方通过丙方向乙方提供借款：
			...
			<td class="l4">
				...
				<span class="key"><fmt:formatDate value="${contract.start_date}" pattern="yyyy年MM月dd日" /></span>起至
				<span class="key"><fmt:formatDate value="${contract.end_date}" pattern="yyyy年MM月dd日" /></span>止。
			</td>
			</tr>
			...
			<td class="l2">
				...
				<span class="key"><fmt:formatNumber value="${contract.interest_allah}" pattern="0.00" /></span>元（大写：人民币 
			...
			<tr>
			<td class="l4">
				乙方应当于 <span class="key"><fmt:formatDate value="${contract.end_date}" pattern="yyyy年MM月dd日" />  17：00 </span>前，按照本合同及丙方交易规则之规定，一次性清偿全部借款本息。
			</td>
			</tr>
			<tr>
			<td class="l2">
			...
			<tr>
			<td class="l2">
				本条约定之交易日，是指丙方交易平台提供相关投融资中介服务业务的工作时间，一般为周一至周五的9：00（am）-17:00（pm），特殊时间以交易平台的具体通知为准。
			</td>
			</tr>
			...
			<tr>
				<td class="l2"><span class="bold">第七条</span> 甲方授权丙方向乙方收取其归还的本金及利息以及约定的其他罚息、违约金等。丙方收到乙方归还的上述款项后，应于三个交易日内，按照相关交易规则，将相应款项经结算后清算至甲方对应的交易账户。</td>
			</tr>
			<tr>
			...
			<tr>
			<td class="l2">
				<span class="bold">第九条</span> 因本合同第六、七、八条约定的款项划转，依据税法规定，如果产生所得税、营业税、个人所得税等纳税义务，则甲方、乙方应当各自依法纳税。丙方不承担甲乙双方投融资交易发生的税款；丙方并不在甲乙双方投融资交易中赚取差价。
			</td>
			</tr>
			<tr>
				<td class="l2">
					丙方接受授权，对相应款项进行划转时，若产生相关手续费、结算费用等，均由甲、乙各方或共同承担，丙方不应承担该笔费用；若丙方代垫的，丙方有权向甲、乙之任一一方请求支付，并有权直接从融资款项中扣除，甲乙双方对此不持异议。
				</td>
			</tr>
			
			<tr>
			<td class="l2">
				<span class="bold">第十条</span> 借款交付后，丙方有权对乙方借款的使用情况，进行必要的监管，但该项权利不得依据任何理由视为丙方之义务。
			</td>
			</tr>
			
			<tr>
			<td class="l2">
				<span class="bold">第十一条</span> 甲方授权丙方对乙方履行本合同的情况进行管理与监控并在乙方发生违约时向乙方追索违约金及相应损失；但该项授权不应当以任何理由视为丙方之义务。
			</td>
			</tr>
			...
			<tr>
			<td class="l4">
				四、乙方拒绝纠正或者其实际行为表明不纠正违反本合同的行为，且情节严重的；
			</td>
			</tr>
			<tr>
			<td class="l4">
			...
			<tr>
			<td class="l4">
				七、针对本合同约定借款，乙方出现需要保证机构代偿款项的逾期还款违约行为的；前述逾期还款不应当包括乙方在保证人代偿期间，清偿当期应还款额的情况。保证人代偿期间，是指保证人签订的《保证合同》中约定的，保证人应当代为清偿被担保债务的期间，分为3日、7日、15日不等，具体以《保证合同》约定为准。
			</td>
			</tr>
			<tr>
			<td class="l4">
			...
			<tr>
			<td class="l4">
				一、乙方出现本合同第十九条约定的情形或违反本合同约定的，最终导致丙方解除本合同、提前收回全部借款本息时，除结清全部借款本金及利息（计算至结清日当天）外，乙方应另行向甲方支付借款金额的<span class="key">5%</span>作为违约金，若违约金不足以偿付甲方、丙方因索赔而产生的各项费用时，甲方和丙方都有权继续向乙方索赔。
			</td>
			</tr>
			<tr>
			<td class="l4">
				二、乙方未按本合同约定按时、足额偿还借款本息的，自逾期之日起应向甲方每日按应还款金额的 <span class="key">0.5%</span> 支付滞纳金。
			</td>
			</tr>
			<tr>
			<td class="l4">
				三、在本合同项下的借款本息全部清偿前，乙方的联系方式、实际居住地、工作单位、资产、负债等情况发生变化，未在变更后三日内书面通知丙方的，上述行为每发生一次，乙方应向丙方支付 <span class="key">500</span> 元/项（次）的违约金。
			</td>
			</tr>
			<tr>
			<td class="l4">
            ...
            <tr>
            <td class="l2">
				<span class="bold">第二十条</span> 本合同履行期间，如果乙方公司发生股权转让、变更等情况的，必须征得丙方的书面同意，未经丙方书面同意，乙方不得签署或实施任何协议或行为，由此导致的全部责任由乙方自行承担。丙方有权直接通知甲方及其他全部出借人解除与乙方的借款合同、提前收回全部借款本息，同时乙方向甲方及丙方各支付人民币<span class="key">10000</span>元的违约金。
			</td>
			</tr>
			
			<tr>
			<td class="l2">
				<span class="bold">第二十一条</span> 乙方承诺如不能按时、足额还款付息，届时放弃抗辩权并愿意接受人民法院强制执行。
			</td>
			</tr>
			
			<tr>
			<td class="l2">
				<span class="bold">第二十二条</span> 本合同在履行过程中如发生纠纷，合同各方同意秉持自愿公平的原则进行协商解决，协商解决不成的，提交丙方所在地有管辖权的法院处理。
			</td>
			</tr>
			
			<tr>
			<td class="l2">
				<span class="bold">第二十三条</span> 本合同为电子合同，由丙方在电子平台发布，该发布是签订合同的邀约，经甲乙双方以会员账号登录丙方电子平台进行确认（电子签署）即后生效，电子签署的日期和时间，即是本合同成立和签订的时间，与纸质合同具同等法律效力。必要时，三方可打印本电子合同为纸质文件签字盖章，自己备查或者办理公证、银行事务等。本合同有效期直至乙方清偿全部借款本金、利息为止，如果发生违约金、赔偿金、维权费用，其有效期直至清偿违约金、赔偿金、维权费用为止。
			</td>
			</tr>
			
			<tr>
			<td class="l2">
				<span class="bold">第二十四条</span> 本合同及甲乙双方的电子签署记录以丙方电子平台的电子数据形式保存于丙方服务器中。甲乙双方可登录丙方电子平台查阅、打印本合同。
			</td>
			</tr>
			<tr>
			<td class="l2">
				本合同各方同意：该电子数据，是解决本合同争议的有效证据。如果法院、仲裁委、政府机关为解决争议需要该电子数据的纸质文档，则以丙方打印并加盖丙方行政公章的纸质文档为有效证据。
			</td>
			</tr>
			
			<tr>
			<td class="l2">
				<span class="bold">第二十五条</span> 若因公证、法律诉讼等原因需要本合同纸质文本打印、复印件时，该打印、复印件上需加盖丙方合同专用行政公章方有效。
			</td>
			</tr>
			
			<tr>
			<td class="l2">
				<span class="bold">第二十六条</span> 本合同所载的“交易账户”为甲和乙方申请成为丙方会员后，在丙方电子平台设立开通的用于投资或借款及相关款项划转的账户，详细内容见甲、乙方各自与丙方签订的《会员协议》。
			</td>
			</tr>
			
			<tr>
			<td class="l2">
				<span class="bold">第二十七条</span> 本合同所载的“会员账号”为甲、乙双方成为丙方会员后丙方为其分配的会员代码同时也是其在丙方电子平台交易账户的账号，详见为甲、乙双方各自与丙方签订的《会员协议》。
			</td>
			</tr>
			
			<tr>
			<td class="l2">
				<span class="bold">第二十八条</span> 甲、乙双方各自与丙方签订的《会员协议》中涉及借款事宜的条款与本合同有冲突的，按《会员协议》的约定执行。
			</td>
			</tr>
			
			<tr>
			<td class="l2">
				<span class="bold">第二十九条</span> 陈述和保证：
			</td>
			</tr>
			<tr>
			<td class="l4">
				<span class="bold">甲乙双方陈述：</span>甲方通过丙方网站和电子平台以及丙方的当面或者电话、短信或者电子邮件的资信、征信介绍，认识了乙方，已经与乙方形成特定的信任关系和伙伴关系，甲乙双方不是互相不认识的不特定关系；
			</td>
			</tr>
			<tr>
			<td class="l4">
			...
			<tr>
			<td class="l4">
				<span class="bold">乙方陈述和保证：</span>乙方知晓丙方是受托于甲方的投资咨询服务机构，丙方的服务性质是居间撮合、受托中介投融资。丙方因为受托于甲乙双方而向乙方划转借款，不属于丙方向乙方发放贷款。乙方保证严格按照合同规定使用借款，如有违约，自觉承担全部违约责任和经济损失。
			</td>
			</tr>
			<tr>
			<td class="l4">
				<span class="bold">丙方陈述和保证：</span>　　丙方拒绝向甲乙双方提供吸收存款获利、集资获利、高利贷、洗钱、非法套现的服务、便利、信息或者渠道。丙方的服务性质，是受甲乙双方委托，居间撮合民间借贷和现行国家政策法律法规许可的投融资咨询服务。丙方保证居间中立和公允。
			</td>
			</tr>
			<br />
			<tr>
