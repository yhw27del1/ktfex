...
保证人代偿期间，是指保证人签订的《保证合同》中约定的，保证人应当代为清偿被担保债务的期间，分为3日、7日、15日不等，具体以《保证合同》约定为准。
			...
			<tr><td class="l4">
				二、乙方未按本合同约定按时、足额偿还借款本息的，自逾期之日起，每逾期一天应向甲方，按应还款金额的<span class="key">${contract.contractTemplate.zhinajinbili}</span>/日的标准支付滞纳金。
			</td></tr>
			<tr><td class="l4">
			...
			<tr><td class="l2">
				<span class="bold">第二十条</span> 本合同履行期间，乙方提前偿还借款的，应向丙方提出书面申请。丙方同意提前还款的，乙方除按实际用款期间支付利息外，还应另向丙方支付 0 天的利息作为违约金。丙方收到此违约金后全额划转至甲方交易账户。
			</td></tr>
			<tr><td class="l2">
				<span class="bold">第二十一条</span>本合同履行期间，如果乙方公司发生股权转让、变更等情况的，必须征得丙方的书面同意，未经丙方书面同意，乙方不得签署或实施任何协议或行为，由此导致的全部责任由乙方自行承担。丙方有权直接通知甲方及其他全部出借人解除与乙方的借款合同、提前收回全部借款本息，同时乙方向甲方及丙方各支付人民币10000元的违约金。
			</td></tr>
			<tr><td class="l2">
				<span class="bold">第二十二条</span> 乙方同意丙方将借款金额的<span class="key"><fmt:formatNumber value="${bzj_bl}" pattern="0.00"/>%</span>冻结在乙方交易账户中作为本合同履约保证金。乙方按时足额归还本息后，丙方将归还履约保证金。乙方不按时足额归还本金支付利息的，丙方不再归还履约保证金。
			</td></tr>
			<tr><td class="l2">
