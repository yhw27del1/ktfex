   ...
   $(document).ready(function(){
	 //时间控件
       ...
       $("#ui-datepicker-div").css({'display':'none'});
			...
			$("#checksubmitBtn").click(function() {
                ...
                if (preInvest== "1") {               
			            var msg = "您真的确定要开启投标优先吗？请确认！"; 
						if (confirm(msg)==true){ 
						     window.location.href = "/back/financingBaseAction!guadan?id=${id}&actionUrl=${actionUrl}&financingBase.startDate="+$("#startDate").val()+"&financingBase.endDate="+$("#endDate").val()+"&financingBase.preInvest="+preInvest+"&groupIds="+groupIds+"&conTemplateId="+conTemplateId;       
						}else{ 
						   return false; 
						}      
                 }else{  
                 	 window.location.href = "/back/financingBaseAction!guadan?id=${id}&actionUrl=${actionUrl}&financingBase.startDate="+$("#startDate").val()+"&financingBase.endDate="+$("#endDate").val()+"&groupIds="+groupIds+"&conTemplateId="+conTemplateId;       
                }
	...
	<body class="ui-widget-header" style="color: black"> 
			<input type='hidden' class='autoheight' value="auto" />  
			    ...
			    <tr  > 
					<td style="padding-left:30px;"  style="color:black">
						...
						<c:if test="${(financingBase.state=='0')||(financingBase.state=='1')||(financingBase.state=='1.5')}">
		    ...
		    <tr>
				...
				--><s:radio list="#{'0':'关闭优先投标'}" name="financingBase.preInvest"  id='financingBasePreInvest'/>
				</td>   
			</tr>
