		 ...
		 $(".table_solid").tableStyleUI(); 
		   ...
		   $("#startDate").datepicker({
		    ...
		    $("#addToUrl").click(function() {
                ...
                var tarUrl = '/back/userGroupAction!addUsers';
                if(categories == null || categories ==""){
                    alert("请至少选择一项！");
                    return false;
                }
                var groupId = $("#groupId").val();
                $.ajax({url:"/back/userGroupAction!addUsers",
                    type:"post",
                    dataType:"json",
			...
			<div id="myToolBar" style="height: 70px;"
				...
				<div style="float: left;">
                    ...
                    <input class="input_box" style="width: 120px;"
                        ...
                        <input type="button" class="ui-state-default" id="addToUrl" value="添加到分组" >
                        <button class="ui-state-default" onclick="toURL('/back/userGroupAction!groupSelectUserList?id=${id}');return false;" />返回</button>
					</div>
				</div>
