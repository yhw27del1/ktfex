...
<html>
	...
	<body>
		...
		<table width="100%" id="main_table">
				...
				<tr><td class="l2">二、乙方户实际借款人违反合同关于借款用途的相关法律规定的；</td></tr>
				...
				<tr><td class="l2">七、乙方任何一期借款未按时或足额还款的；</td></tr>
				<tr><td class="l2">八、乙方其他任何一笔借款（即其他任何负债）未按时、足额还款（含一期）的；</td></tr>
				<tr><td class="l2">九、乙方或实际借款人经营的公司出现经营恶化、面临被查封、停业、行业整顿或被处置资产等情形；</td></tr>
				<tr><td class="l2">十、乙方在本合同项下的借款本息全部清偿前，未经丙方书面同意向第三人提供担保的（因本合同乙方的担保人要求乙方提供反担保，且反担保协议经甲方同意的情形除外）；</td></tr>
				...
				<tr><td class="l2"><span class="bold">第二十二条</span> 丙方有权根据本合同第二十条的约定行使甲方授权的相关权利，在本合同履行过程中，丙方仅履行代收、代转已经从乙方收到款项的责任，在乙方以及担保人不能如约履行还款义务时，丙方不承担向甲方支付、赔付、垫付任何款项等的责任。若甲方要求丙方向债务人追收欠款的，甲方需预付追债费用，本合同履行期间，乙方提前偿还借款的，应向丙方提出书面申请。丙方同意提前还款的，乙方除按实际用款期限（不足一个月的，按一个月计）支付利息外，还应另向丙方支付一个月的利息作为违约金。丙方收到此违约金后全额划转至甲方交易账户。</td></tr>
				...
				<tr><td class="l2"><span class="bold">第三十三条</span> 本合同自签署之日起生效。合同的附件与本合同具有相同的法律效力。</td></tr>
				<tr><td class="l2"><span class="bold">第三十四条</span> 定义</td></tr>
				<tr><td class="l2">实际借款人，是指委托乙方通过丙方之融资平台，向甲方进行融资，并由丙方接受委托，将融资款项支付至指定账户的实际用款人。</td></tr>
				<tr><td class="l2"><span class="bold">第三十五条</span> 陈述和保证</td></tr>
