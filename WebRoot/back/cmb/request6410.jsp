...
<table border="0">
	<tr>
		...
		<td>
			<input name="request6410.bankAcc" type="text" value="871903469010901" />
		</td>
		<td>
			<button onclick="toURL('/back/cmb/cmbAction!request6410_do');return false;" class="ui-state-default" >查询交易所余额</button>
		</td>
	</tr>
</table>
</form>
