...
<table border="0">
	<tr>
		...
		<td>
			<input name="request6200.bankAcc" maxlength="20" type="text"/>
		</td>
		<td align="right">
			<span style="color: red">*</span>交易帐号：
		</td>
		<td>
			<input name="request6200.fundAcc" maxlength="20" type="text"/>
		</td>
		<td align="right">
		...
		<td>
			<select name="request6200.iDType">
	...
	<tr>
		...
		<td>
			<input name="request6200.iDNo" maxlength="20" type="text"/>
		</td>
		<td align="right">
			<span style="color: red">*</span>客户名称：
		</td>
		<td>
			<input name="request6200.custName" maxlength="20" type="text"/>
		</td>
		<td>
			<button onclick="toURL('/back/cmb/cmbAction!request6200_do');return false;" class="ui-state-default" >入金</button>
		</td>
	</tr>
</table>
</form>
