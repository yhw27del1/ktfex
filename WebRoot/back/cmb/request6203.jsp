...
<table border="0">
	<tr>
		...
		<td>
			<input name="request6203.bankAcc" maxlength="20" type="text"/>
		</td>
		<td align="right">
			<span style="color: red">*</span>交易帐号：
		</td>
		<td>
			<input name="request6203.fundAcc" maxlength="20" type="text"/>
		</td>
		<td align="right">
		...
		<td>
			<select name="request6203.iDType">
	...
	<tr>
		...
		<td>
			<input name="request6203.iDNo" maxlength="20" type="text"/>
		</td>
		<td align="right">
			<span style="color: red">*</span>客户名称：
		</td>
		<td>
			<input name="request6203.custName" maxlength="20" type="text"/>
		</td>
		<td>
			<button onclick="toURL('/back/cmb/cmbAction!request6203_do');return false;" class="ui-state-default" >重发出金</button>
		</td>
	</tr>
</table>
</form>
