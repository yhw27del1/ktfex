...
<table border="0">
	<tr>
		...
		<td>
			<input name="request6400.fundAcc" maxlength="20" type="text"/>
		</td>
		<td>
			<button onclick="toURL('/back/cmb/cmbAction!request6400_do');return false;" class="ui-state-default" >查询会员余额</button>
		</td>
	</tr>
</table>
</form>
