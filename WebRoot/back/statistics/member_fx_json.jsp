...
<html>
	...
	<body>
	 	<table id="fx_dg" width="100%" style="height:436px;" class="easyui-datagrid"
            data-options="rownumbers:true,
            singleSelect:true,
            method:'post',
            url:'/back/stcsMemBaseAction!member_fx_list?username=<%=username %>',
            showFooter: true,
            width:878
            ">
	        <thead>
	            <tr>
		        	<th data-options="field:'STATE',width:80,formatter:p_state_formatter">还款状态</th>
		        	<th data-options="field:'COUNTS',width:100">还款条数</th>
		        	<th data-options="field:'scale',width:100,formatter:scale_formatter">所占比例</th>
	            </tr>
	        </thead>
	    </table>
...
function scale_formatter(val,row,index){
	return val+"%";
}
