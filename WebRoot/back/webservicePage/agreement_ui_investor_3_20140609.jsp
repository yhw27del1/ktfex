	...
	<body>
	 <input type='hidden' class='autoheight' value="auto" />  
		...
		<div style="width:900px;overflow-x:hidden;margin-left:auto;margin-right:auto;margin-top:30xp;"  id="maindiv">
				...
				<div class="l2">若第三条约定为到期一次还本付息，则乙方应于第一条借款期限届满前或当天全额清偿应还的本金及利息。<br/>
　　 若本条约定之还款日逢国家法定节假日，则相应还款日应提前至该节假日前的最后一个交易日。若当月无该日期的，相应还款日提前至该日期前的最后一个交易日。<br/>
　　本条约定之交易日，是指丙方交易平台提供相关投融资中介服务业务的工作时间，一般为周一至周五的9：00（am）-17:00（pm），特殊时间以交易平台的具体通知为准。<br/>
　　甲乙双方是丙方的注册会员，甲方持有合法资金并自愿寻求投资对象，获取投资收益，乙方需要资金维持经营/创业/发展事业/或者个人事务，丙方是依法注册成立的投资咨询中介服务机构，具有规范、安全交易服务的完善机制，帮助交易双方实现投融资。为此，本合同三方根据我国《民法通则》、《合同法》、民间借贷政策法规、金融管理法规等相关法律法规，在自愿、平等、协商一致的基础上，签订本合同，各方信守。</div>
...
尽管甲乙双方在第二十条授权丙方，以及丙方根据该授权行使权利，但是，丙方没有向甲方支付、赔付、垫付任何款项的经济责任，丙方只有代收、代转已经从乙方收到的债款的义务和经济责任。甲方要求丙方向债务人追收欠款的，甲方需预付追债费用。</div>
				...
				<div class="l2"><span class="bold">第二十三条</span> 乙方同意丙方将借款金额<span class="key"><fmt:formatNumber value="${bzj_bl}" pattern="0.00"/>%</span>冻结在乙方交易账户中作为履约保证金。乙方按时足额归还本息后，丙方将归还履约保证金。乙方不按时足额归还本金支付利息的，丙方不再归还履约保证金。</div>
				...
				<div class="l2"><span class="bold">第二十六条</span> 本合同为电子合同，由丙方在电子平台发布，经甲乙双方以会员账号登录丙方电子平台进行确认（电子签署）即后生效，电子签署的日期，即是本合同成立和签订的时间，与纸质合同具同等法律效力。必要时，三方可打印本电子合同为纸质文件签字盖章，自己备查或者办理公证、银行事务等。本合同有效期直至乙方清偿全部借款本金、利息为止，如果发生违约金、赔偿金、维权费用，其有效期直至清偿违约金、赔偿金、维权费用为止。</div>
				<div class="l2"><span class="bold">第二十七条</span> 本合同及甲乙双方的电子签署记录以电子数据形式保存于丙方服务器中。甲乙双方可登录丙方电子平台查阅或打印本合同。本合同各方同意：该电子数据，是解决本合同争议的有效证据。如果法院、仲裁委、政府机关为解决争议需要该电子数据的纸质文档，则以丙方打印并加盖丙方行政公章的纸质文档为有效证据。</div>
				<div class="l2"><span class="bold">第二十八条</span> 若因公证、法律诉讼等原因需要本合同纸质文本打印、复印件时，该打印、复印件上需加盖丙方合同专用行政公章方有效。</div>
				<div class="l2"><span class="bold">第二十九条</span> 本合同所载的“交易账户”为甲和乙方申请成为丙方会员后，在丙方电子平台设立开通的用于投资或借款及相关款项划转的账户，详细内容见甲、乙方各自与丙方签订的《会员协议》。</div>
				<div class="l2"><span class="bold">第三十条</span> 本合同所载的“会员账号”为甲、乙双方成为丙方会员后丙方为其分配的会员代码同时也是其在丙方电子平台交易账户的账号，详见为甲、乙双方各自与丙方签订的《会员协议》。</div>
				<div class="l2"><span class="bold">第三十一条</span> 甲、乙双方各自与丙方签订的《会员协议》中涉及借款事宜的条款与本合同有冲突的，按《会员协议》的约定执行。</div>
				<div class="l2"><span class="bold">第三十二条</span> 定义</div>
