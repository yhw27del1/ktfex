	...
	<body>
	 <input type='hidden' class='autoheight' value="auto" />  
		...
		<div style="width:900px;overflow-x:hidden;margin-left:auto;margin-right:auto;margin-top:30xp;"   id="maindiv">
			...
			<div class="l4">
				乙方应当于 <span class="key"><fmt:formatDate value="${contract.end_date}" pattern="yyyy年MM月dd日" />17：00（am）</span>前，按照本合同及丙方交易规则之规定，一次性清偿全部借款本息。
			</div>
			<div class="l4">
			...
			<div class="l2">
				<span class="bold">第七条</span> 甲方授权丙方向乙方收取其归还的本金及利息以及约定的其他违约金等。丙方收到乙方归还的上述款项后应于三个交易日内将相应款项经结算后拨付至甲方对应的交易账户。
			</div>
...
保证人代偿期间，是指保证人签订的《保证合同》中约定的，保证人应当代为清偿被担保债务的期间，分为3日、7日、15日不等，具体以《保证合同》约定为准。
			...
			<div class="l2">
				<span class="bold">第二十二条</span> 乙方同意丙方将借款金额的    %冻结在乙方交易账户中作为履约保证金。乙方按时足额归还本息后，丙方将归还履约保证金。乙方不按时足额归还本金支付利息的，丙方不再归还履约保证金。
			</div>
			<div class="l2">
