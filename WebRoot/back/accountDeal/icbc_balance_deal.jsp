...
<html>
	...
	<body>
		<table id="dg" class="easyui-datagrid"
            ...
            url:'/back/accountDealAction!icbc_balance_deal_data',
            singleSelect:true,
            method:'get',
            toolbar:'#tb',
            pagination:true,
	        ...
	        <thead data-options="frozen:true">
	        	<tr>
		            ...
		            <th data-options="field:'SIGNDATE',width:120,formatter:date_formatter">变更日期</th>
		            <th data-options="field:'CHANNEL',width:130,formatter:channel_formatter">专户</th>
		            <th data-options="field:'NAME',width:120">变更名称</th>
		            <th data-options="field:'OPERATER',width:120">操作员</th>
	    ...
	    <div id="tb" style="padding:5px;height:auto">
	        <div>
	        	...
	        	变更日期:<input class="easyui-datebox" name="startDate" style="width:100px" placeholder="开始日期" value="<fmt:formatDate value="<%=now %>" pattern="yyyy-MM-dd"/>">
	            ...
	            <a href="javascript:;" pre-href="/back/accountDealAction!icbc_balance_deal_data" id="print" class="easyui-linkbutton" iconCls="icon-print">打印</a>
	        </div>
	    </div>
	    <div id="win"></div>
...
<script>
	...
	$(function(){
		...
		$("#search").click(function(){
			var source_url = '/back/accountDealAction!icbc_balance_deal_data';
