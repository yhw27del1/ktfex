...
<html>
	...
	<body>
		<table id="dg" class="easyui-datagrid"
            ...
            url:'/back/accountDealAction!icbc_business_deal_data',
            singleSelect:true,
            method:'get',
            toolbar:'#tb',
            pagination:true,
	    ...
	    <div id="tb" style="padding:5px;height:auto">
	        <div>
	            ...
	            <a href="javascript:;" pre-href="/back/accountDealAction!icbc_business_deal_data" id="print" class="easyui-linkbutton" iconCls="icon-print">打印</a>
	        </div>
	    </div>
	    <div id="win"></div>
...
<script>
	...
	$(function(){
		...
		$("#search").click(function(){
			var source_url = '/back/accountDealAction!icbc_business_deal_data';
