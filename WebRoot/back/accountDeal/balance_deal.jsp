...
<html>
	...
	<body>
		<table id="dg" class="easyui-datagrid"
            ...
            url:'/back/accountDealAction!balance_data',
            singleSelect:true,
            method:'get',
            toolbar:'#tb',
            pagination:true,
	        ...
	        <thead data-options="frozen:true">
	        	<tr>
		            ...
		            <th data-options="field:'SIGNDATE',width:120,formatter:date_formatter">签约日期</th>
		            <th data-options="field:'SURRENDERDATE',width:120,formatter:date_formatter">解约日期</th>
		            ...
		            <th data-options="field:'NAME',width:90">签约方式</th>
	    ...
	    <div id="tb" style="padding:5px;height:auto">
	        <div>
	            ...
	            <a href="javascript:;" pre-href="/back/accountDealAction!balance_data" id="print" class="easyui-linkbutton" iconCls="icon-print">打印</a>
	        </div>
	    </div>
	    <div id="win"></div>
...
<script>
	...
	$(function(){
		...
		$("#search").click(function(){
			var source_url = '/back/accountDealAction!balance_data';
