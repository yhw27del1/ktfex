...
<body>
<form action="/back/accountDeal/accountDealAction!lx_import" method="post"  enctype="multipart/form-data" id="chargeform">
	<table style="padding:0 0;">
		<tbody>
			<tr>
				...
				<td style="width:50%;">
					<input id="daoru" value="批量导入" type="button" onclick="return charge_import_submit();"/><br />
