...
<table border="0">
	...
	<tr>
		...
		<td>
			<button onclick="toURL('/back/hxbank/hxbankAction!inGoldRequest');return false;" class="ui-state-default" >本行入金</button>
			<button onclick="toURL('/back/hxbank/hxbankAction!outGold');return false;" class="ui-state-default" >本行或他行出金</button>
		</td>
			...
			<c:forEach items="${pageView.records}" var="entry">
					<tr>
						...
						<td style="text-align: right;">
							<fmt:formatNumber value='${entry.amt}' type="currency" currencySymbol=""/>
						</td>
						<td>
