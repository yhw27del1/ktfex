...
<table border="0">
	...
	<tr>
		...
		<td>
			<button onclick="toURL('/back/hxbank/hxbankAction!surrender');return false;" class="ui-state-default" >解约</button>
		</td>
...
<div id="myToolBar"
		class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
				...
				解约日期&nbsp;从&nbsp;<input type="text" name="startDate" value="<fmt:formatDate value='${startDate}' type='date' />" id="startDate"/>&nbsp;到&nbsp;<input type="text" name="endDate" value="<fmt:formatDate value='${endDate}' type='date' />" id="endDate"/>
