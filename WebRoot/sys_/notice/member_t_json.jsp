...
<html>
	...
	<body>
	 	<table id="invest_dg" class="easyui-datagrid"
		            ...
		            singleSelect:false,
		            url:'/sys_/notice/noticeAc!member_json?userType=T&first=1',   
		            method:'get',
		            toolbar:'#invest_tb',
		            pagination:true,
		            height:376,
		            ...
		            <thead>
		                <tr>
			                	...
			                	<th data-options="field:'REGTIME',width:180,sortable:true,formatter:date_formatter" >开户日期</th>
		                </tr>
		            </thead>
			    </table>
			    <div id="invest_tb" style="padding:5px;height:auto">
			        <div>
	                    ...
	                    <input id="qkeyWord" type="text" name="qkeyWord" class="combo"   placeholder="用户名或姓名" /> 
	                     <input id="userType" type="hidden" name="userType" value="T" />   
...
function date_formatter(val,row,index){
	if(val==null){
     ...
     function onSelectAllRow() { 
		    var ids = [];
		    var rows = $('#invest_dg').datagrid('getSelections');   
