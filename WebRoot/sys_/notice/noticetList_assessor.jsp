...
<html>
	...
	<body>
		<table id="dg" class="easyui-datagrid"
            ...
            url:'/sys_/notice/noticeAc!list_assessor',   
            singleSelect:true,
            method:'get',
            toolbar:'#tb',
            pagination:true,
	        ...
	        <thead data-options="frozen:true">
	        	<tr> 
		            ...
		            <th data-options="field:'TARGETUSER',width:250,sortable:true,formatter:targetuser_formatter">目标用户</th>  
		            <th data-options="field:'SHOWOK',width:95,formatter:operator_formatter">操作</th>
		        </tr> 
	        </thead>
   ...
   window.location.href = url; 
	...
	function operator_formatter(val,row,index){ 
		   ...
		   if (row.STATE == '1' || row.STATE == '3' ){           
			  str += '<a href="javascript:;" onclick="javascript:confirmInfo(\'您确定要审核通过吗?\',\'/sys_/notice/noticeAc!state_assessor?id='+row.ID+'&notice.audit_state=2\');return false;" >审核通过</a>&nbsp;&nbsp;&nbsp;'; 
			  str += '<a href="javascript:;" onclick="javascript:confirmInfo(\'您确定要驳回吗?\',\'/sys_/notice/noticeAc!state_assessor?id='+row.ID+'&notice.audit_state=3\');return false;" >驳回</a>';       
		   }
		   else{ 
			  str += '未处理';   
		   }     
	...
	$(function(){
		...
		$("#search").click(function(){
			var source_url = '/sys_/notice/noticeAc!list_assessor';    
