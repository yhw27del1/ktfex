...
/**
 * <p>
 * Java class for ResponseDZ008 complex type.
 * 
 * <p>
 ...
 * 
 * <pre>
 * &lt;complexType name="ResponseDZ008">
 *   &lt;complexContent>
 ...
 *         &lt;element name="failedLiquidations" type="{http://entry.response.B2B.hitrust.com}ArrayOfFailedLiquidationEntry" minOccurs="0"/>
...
@XmlType(name = "ResponseDZ008", namespace = "http://response.B2B.hitrust.com", propOrder = {
		"batchNo", "code", "document", "failedLiquidations", "language",
		"merchantTrnxNo", "message", "serverTime", "signFlag", "signature",
		"signatureAlgorithm", "successed", "trnxCode", "version", "workday" })
public class ResponseDZ008 {
	...
	@XmlElementRef(name = "failedLiquidations", namespace = "http://response.B2B.hitrust.com", type = JAXBElement.class)
	protected JAXBElement<ArrayOfFailedLiquidationEntry> failedLiquidations;
	...
	/**
	 * Gets the value of the failedLiquidations property.
	 * 
	 * @return possible object is {@link JAXBElement }{@code <}
	 *         {@link ArrayOfFailedLiquidationEntry }{@code >}
	 * 
	 */
	public JAXBElement<ArrayOfFailedLiquidationEntry> getFailedLiquidations() {
		return failedLiquidations;
	}

	/**
	 * Sets the value of the failedLiquidations property.
	 * 
	 * @param value
	 *            allowed object is {@link JAXBElement }{@code <}
	 *            {@link ArrayOfFailedLiquidationEntry }{@code >}
	 * 
	 */
	public void setFailedLiquidations(
			JAXBElement<ArrayOfFailedLiquidationEntry> value) {
		this.failedLiquidations = ((JAXBElement<ArrayOfFailedLiquidationEntry>) value);
	}
