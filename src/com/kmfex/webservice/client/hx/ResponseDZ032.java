...
/**
 * <p>
 * Java class for ResponseDZ032 complex type.
 * 
 * <p>
 ...
 * 
 * <pre>
 * &lt;complexType name="ResponseDZ032">
 *   &lt;complexContent>
 ...
 *         &lt;element name="boothNo" type="{http://www.w3.org/2001/XMLSchema}string" minOccurs="0"/>
...
@XmlType(name = "ResponseDZ032", namespace = "http://response.B2B.hitrust.com", propOrder = {
		"accountNo", "bankAmt", "bankAmtUse", "bankTxSerNo", "boothNo", "code",
		"document", "language", "merchantTrnxNo", "message", "serverTime",
		"signFlag", "signature", "signatureAlgorithm", "successed", "trnxCode",
		"version" })
public class ResponseDZ032 {

	@XmlElementRef(name = "accountNo", namespace = "http://response.B2B.hitrust.com", type = JAXBElement.class)
	...
	@XmlElementRef(name = "boothNo", namespace = "http://response.B2B.hitrust.com", type = JAXBElement.class)
	protected JAXBElement<String> boothNo;
	...
	/**
	 * Gets the value of the boothNo property.
	 * 
	 * @return possible object is {@link JAXBElement }{@code <}{@link String }
	 *         {@code >}
	 * 
	 */
	public JAXBElement<String> getBoothNo() {
		return boothNo;
	}

	/**
	 * Sets the value of the boothNo property.
	 * 
	 * @param value
	 *            allowed object is {@link JAXBElement }{@code <}{@link String }
	 *            {@code >}
	 * 
	 */
	public void setBoothNo(JAXBElement<String> value) {
		this.boothNo = ((JAXBElement<String>) value);
	}
