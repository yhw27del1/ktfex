...
/**
 * <p>
 * Java class for ResponseDZ020 complex type.
 * 
 * <p>
 ...
 * 
 * <pre>
 * &lt;complexType name="ResponseDZ020">
 *   &lt;complexContent>
 *     &lt;restriction base="{http://www.w3.org/2001/XMLSchema}anyType">
 *       &lt;sequence>
 *         &lt;element name="accountRegs" type="{http://entry.response.B2B.hitrust.com}ArrayOfReAccountRegEntry" minOccurs="0"/>
...
@XmlType(name = "ResponseDZ020", namespace = "http://response.B2B.hitrust.com", propOrder = {
		"accountRegs", "bankTxSerNo", "code", "document", "language",
		"merchantTrnxNo", "message", "serverTime", "signFlag", "signature",
		"signatureAlgorithm", "successed", "trnxCode", "version" })
public class ResponseDZ020 {

	@XmlElementRef(name = "accountRegs", namespace = "http://response.B2B.hitrust.com", type = JAXBElement.class)
	protected JAXBElement<ArrayOfReAccountRegEntry> accountRegs;
	...
	/**
	 * Gets the value of the accountRegs property.
	 * 
	 * @return possible object is {@link JAXBElement }{@code <}
	 *         {@link ArrayOfReAccountRegEntry }{@code >}
	 * 
	 */
	public JAXBElement<ArrayOfReAccountRegEntry> getAccountRegs() {
		return accountRegs;
	}

	/**
	 * Sets the value of the accountRegs property.
	 * 
	 * @param value
	 ...
	 * 
	 */
	public void setAccountRegs(JAXBElement<ArrayOfReAccountRegEntry> value) {
		this.accountRegs = ((JAXBElement<ArrayOfReAccountRegEntry>) value);
	}
