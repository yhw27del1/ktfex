...
/**
 * <p>
 * Java class for ResponseDZ009 complex type.
 * 
 * <p>
 ...
 * 
 * <pre>
 * &lt;complexType name="ResponseDZ009">
 *   &lt;complexContent>
 ...
 *         &lt;element name="failedAccountChecks" type="{http://entry.response.B2B.hitrust.com}ArrayOfFailedAccountCheckEntry" minOccurs="0"/>
...
@XmlType(name = "ResponseDZ009", namespace = "http://response.B2B.hitrust.com", propOrder = {
		"batchNo", "code", "document", "failedAccountChecks", "language",
		"merchantTrnxNo", "message", "serverTime", "signFlag", "signature",
		"signatureAlgorithm", "successed", "trnxCode", "version", "workday" })
public class ResponseDZ009 {

	@XmlElementRef(name = "batchNo", namespace = "http://response.B2B.hitrust.com", type = JAXBElement.class)
	...
	@XmlElementRef(name = "failedAccountChecks", namespace = "http://response.B2B.hitrust.com", type = JAXBElement.class)
	protected JAXBElement<ArrayOfFailedAccountCheckEntry> failedAccountChecks;
	...
	@XmlElementRef(name = "workday", namespace = "http://response.B2B.hitrust.com", type = JAXBElement.class)
	protected JAXBElement<String> workday;
	...
	/**
	 * Gets the value of the failedAccountChecks property.
	 * 
	 * @return possible object is {@link JAXBElement }{@code <}
	 *         {@link ArrayOfFailedAccountCheckEntry }{@code >}
	 * 
	 */
	public JAXBElement<ArrayOfFailedAccountCheckEntry> getFailedAccountChecks() {
		return failedAccountChecks;
	}

	/**
	 * Sets the value of the failedAccountChecks property.
	 * 
	 * @param value
	 *            allowed object is {@link JAXBElement }{@code <}
	 *            {@link ArrayOfFailedAccountCheckEntry }{@code >}
	 * 
	 */
	public void setFailedAccountChecks(
			JAXBElement<ArrayOfFailedAccountCheckEntry> value) {
		this.failedAccountChecks = ((JAXBElement<ArrayOfFailedAccountCheckEntry>) value);
	}
	 ...
	 * 
	 */
	public JAXBElement<String> getWorkday() {
		return workday;
	}
	 ...
	 * 
	 */
	public void setWorkday(JAXBElement<String> value) {
		this.workday = ((JAXBElement<String>) value);
	}
